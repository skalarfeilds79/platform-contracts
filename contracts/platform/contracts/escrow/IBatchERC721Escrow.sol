...
contract IBatchERC721Escrow {
    ...
    function callbackEscrow(
        BatchERC721Escrow.Vault memory vault, address callbackTo, bytes memory callbackData
     ...
     */
    function escrow(BatchERC721Escrow.Vault memory vault, address from) public returns (uint256 vaultID);
